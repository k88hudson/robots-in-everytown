(function(){
  ...
  document.addEventListener( "DOMContentLoaded", function( e ){
    ...
    _comm.listen( "trackeventdata", function( e ){
      ...
      //Vintage image stuff
        if( jQuery && e.data.manifest.about.name === "Popcorn image Plugin" && e.data.popcornOptions.src ) {

          $(".vintage").show().click(function(){
            var $img = $("<img src=\"" + e.data.popcornOptions.src + "\">");
            $img.vintage({
                vignette: {
                    black: 0.8,
                    white: 0.1
