      ...
      manifest: {
        ...
        options: {
          ...
          innerCSS: {
            ...
            type: "text",
            label: "Inner CSS",
            "default": "font-family: 'lovers-quarrel', Georgia; font-size: 100px; margin: 0 20px;"
          },
          innerClasses: {
            elem: "input",
            type: "text",
            label: "Inner Classes",
            "default": "rumble-light blur padWithSpaces"
          },
          baseClass: {
            elem: "input",
            type: "text",
            label: "Base Class",
            "default": "supertext-container"
          },
          inactiveClass: {
            elem: "input",
            type: "text",
            label: "Inactive Class",
            "default": "supertext-off"
          },
          activeClass: {
            elem: "input",
            type: "text",
            label: "Active Class",
            "default": "supertext-on"
          },
