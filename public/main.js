  ...
  (function( Butter ) {
    ...
    //Apply the editing functions to the existing track events 
      ...
      function updateFunction(e) {
        ...
        if( trackEvent.type === "supertext" 
         || trackEvent.type === "title-top"
         || trackEvent.type === "title-mid"
         || trackEvent.type === "title-bottom" ) {
          ...
          window.$ && $( _container ).resizable({
            ...
            stop: function(event, ui) {
              ...
              trackEvent.update({ height: ui.size.height, width: ui.size.width + "px" })
            }
          }).draggable({
            stop: function(event, ui) {
                trackEvent.update({top: ui.position.top + "px", left: ui.position.left + "px" });
